...
- **Angle is a `FundamentalDimension` and is present in dimensionalities like Torque and MomentOfInertia.**  While the angular aspect of these kind of units is often ignored, treating radians as a length ratio, the angular aspect is preserved by default.
