...
/// how uncertainties combine (e.g. root-sum-of-squares vs. direct sum) and what concrete
...
/// conservative uncertainties, returning a symmetric result when all operands are symmetric and an asymmetric one
...
public interface IUncertaintyPropagator
{
    ...
    /// </summary>
    /// <param name="method">Whether the operands' uncertainties are treated as correlated or uncorrelated.</param>
