...
/// <see cref="Comparable"/> — which is exactly right: an unanswerable comparison is not accepted by an accept-anything
...
/// changing either can see the other. <c>MustBeTests</c> pins the correspondence.
/// </para>
/// </remarks>
[Flags]
public enum MustBe : byte
{
    ...
    Comparable = LessThan | GreaterThan | EqualTo,
}
